...
write.csv(results_df,file="FDR_AR1_upk.csv", row.names = TRUE) 
results_df
read.csv("FDR_AR1_upk.csv")
...
results_df <- do.call(rbind, results_list)
results_df
write.csv(results_df,file="FDR_BlockDiagonal_upk.csv", row.names = TRUE)
...
results_df <- do.call(rbind, results_list)
results_df
write.csv(results_df,file="FDR_SmallWorld_upk.csv", row.names = TRUE)
